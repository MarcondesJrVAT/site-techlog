    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 animate fadeInLeft">
                ...
                <a href="/fale-conosco" class="btn btn-techlog" data-text="Saiba mais">Saiba mais</a>
...
<div class="contact-us-bar">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="text-left">
                    <a href="/fale-conosco" class="btn btn-techlog get-in-touch animate fadeInRight" data-text="Fale Conosco"><i class="icon-telephone114"></i>Fale Conosco</a>
                </div>
            </div>
        </div>
    </div>
